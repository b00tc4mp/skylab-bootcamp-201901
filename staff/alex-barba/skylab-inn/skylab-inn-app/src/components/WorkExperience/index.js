    ...
    return (
        <div className='workExp-container'>
            ...
            {addWorkExperience && <div className='workExp-container__form'><form onSubmit={e => handleAddInformation(e, 'Work')}><input type='text' name='company' placeholder='Company' onChange={e => setCompany(e.target.value)} required></input>
                ...
                &nbsp;<div className='checkbox'><input type='checkbox' id='current' name='current'  onChange={e => setCurrent(e.target.checked)}/><label hmtlFor='current'>&nbsp; Current job</label></div>
                <div>
                ...
                return <div className='workExp-container__form'>
                    {editWork === exp._id ?
                        <form onSubmit={e => handleUpdateInformation(e, 'Work', exp._id)}>
                            ...
                            <div className='checkbox'><input type='checkbox' id='current' name='current' onChange={e => setCurrent(e.target.checked)} defaultChecked={exp.current}/><label hmtlFor='current'>&nbsp; Current job</label></div>
                            <div>
                        ...
                        <div className='workExp-container__content'>
                            ...
                            {exp.current ? <div className='checkbox'><input type='checkbox' id='current' name='current' checked/><label hmtlFor='current'>&nbsp; Current job</label></div> : <p>{new Date(exp.endDate).toLocaleDateString(undefined, { day: 'numeric', month: 'numeric', year: 'numeric' })}</p>}
                        </div>
                    }
                </div>
            })
