...
function Panel(element) { // De donde heredan todos los componentes y tienen los métodos hide y show
    this.element = element;
}

Panel.prototype.hide = function() { //Esta función y la de show viene de la interfaz polifill en vendor. Ahi establece display: none y display: block
    this.element.hide();
};
...
Object.defineProperty(LoginPanel.prototype, 'onLogin', { //El callback es 
...
function RegisterPanel() {
    ...
    //Panel de error que es un nuevo componente.
    var errorPanel = new ErrorPanel;
    container.appendChild(errorPanel.element);
    this.__errorPanel__ = errorPanel;
