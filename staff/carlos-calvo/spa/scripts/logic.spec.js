...
describe('logic', function () {
    describe('login', function () {
        ...
        it('should fail on wrong password', function () {
            expect(function () {
                login('johndoe@mail.com', 'abc', function () { });
            }).toThrow(Error('wrong password'));
        });

        it('should fail on callback not a function', function () {
            expect(function () {
                login('johndoe@mail.com', '123', false);
            }).toThrow(new TypeError('callback not a function'));
        });

        it('should fail on number as parameter', function () {
            expect(function () {
                login(123, '123', function(){
                    return true
                });
            }).toThrow(new TypeError('email not a string'));
        });

        it('Incorrect number of parameters', function () {
            expect(function () {
                login('jhn@foo.com', '123', function(){
                    return true
                }, false);
            }).toThrow(new Error('Incorrect number of parameters'));
        });
    });
    ...
    describe('register', function () {
        ...
        //////////////////////////////////////////////
        it('should fail on undefined mail', function () {
            var registered;
        ...
        it('should fail on numeric mail', function () {
            var registered;

            var registeringName = 'John';
            var registeringSurname = 'Doe';
            var registeringEmail = 12345;
            var registeringPassword = 'p4ssw0rd';
        ...
        it('should fail on boolean mail', function () {
            var registered;
        ...
        it('should fail on object mail', function () {
            var registered;
        ...
        it('should fail on array mail', function () {
            var registered;
        ...
        it('should fail on empty mail', function () {
            var registered;
        ...
        it('should fail on undefined password conf', function () {
            var registered;
            ...
            var registeringEmail = 'a@a.com'
            var registeringPassword = '12345';
            var passwordConf = undefined

            expect(function () {
                register(registeringName, registeringSurname, registeringEmail, registeringPassword, passwordConf, function () {
                    registered = true;
                });
            }).toThrow(TypeError(passwordConf + ' is not a string'));
        ...
        it('should fail on object password', function () {
            ...
            var registeringSurname = 'doe';
            var registeringEmail = 'a@a.com';
            var registeringPassword = '123456789';
            var passwordConf = {}
        ...
        it('should fail on empty passwordconfirmation', function () {
            ...
            var registeringSurname = 'doe';
            var registeringEmail = 'a@a.com';
            var registeringPassword = '3434343';
            var passwordConf = ''
