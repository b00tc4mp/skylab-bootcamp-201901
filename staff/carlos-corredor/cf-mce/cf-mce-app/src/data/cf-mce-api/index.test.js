...
xdescribe('cf-mce-api', () => {
  ...
  describe('customer', () => {
    ...
    describe('register customer', () => {
		it('should succeed on correct data', async () => {
			await Customer.deleteMany()
			const res = await mceApi.registerCustomer(token, name, surname, phone, address, nid, email)

			expect(res.message).toBe('Ok, customer registered.')
    ...
    describe('list customer', () => {
		...
		describe('list all customer', () => {
			it('should succeed and return customers if customers exist without criteria', async () => {
				const customersListed = await mceApi.findCustomers(token)
			...
			it('should succeed and return customers if customers exist with null like criteria', async () => {
				const customersListed = await mceApi.findCustomers(token, null)
		...
		describe('list customers found by criteria', () => {
			...
			it('should succeed and return customers found by criteria', async () => {
				...
				customersFound = await mceApi.findCustomers(token, criteria)
