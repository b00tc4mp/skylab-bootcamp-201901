...
describe('logic', function () {
    describe('login', function () {
        ...
        it('should fail on undefined email', function () {
            ...
            var loggingEmail = undefined;
            var loggingPassword = 'p4ssw0rd';

            expect(function () {
                login(loggingEmail, loggingPassword, function () {
                    registered = true;
                });
            }).toThrow(TypeError(loggingEmail + ' is not a string'));
        ...
        it('should fail on undefined password', function () {
            ...
            var loggingEmail = 'jw@mail.com';
            var loggingPassword = undefined;

            expect(function () {
                login(loggingEmail, loggingPassword, function () {
                    registered = true;
                });
            }).toThrow(TypeError(loggingPassword + ' is not a string'));
    ...
    //____________________REGISTER____________________________//
