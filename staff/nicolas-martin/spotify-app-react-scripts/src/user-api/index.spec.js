...
describe('user api', () => {
    ...
    describe('remove', () => {
        ...
        // it('should fails on retrieve an user with no token', () => {
        //     let invalidToken = 'test'
        //     // console.log('Wrong', invalidToken)
        //     // console.log('Correcto:', _token)
        //     return userApi.retrieve(_id, invalidToken)
        //         .then(()=> {
        ...
        // it ('should fail on retrieve an id with wrong password', () => 
        //     userApi.authenticate(username, '1233123')
        //         .then(() => {
        //             throw Error('should not passed over here')
        //         })
        //         .catch(error => {
