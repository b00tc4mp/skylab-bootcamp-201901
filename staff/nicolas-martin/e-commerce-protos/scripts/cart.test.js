...
suite("cart", function(){
    ...
    describe('mostExpensive', function () {// use case 2
    ...
    describe('numberOfItems', function () { // use case 3
    ...
    describe('mostExpensive', function () { // use case 4
    ...
    describe('numberOf', function () { // use case 5
    ...
    describe('numberOf', function () { // use case 7// use case 6
    ...
    describe('createSetOfProducts', function () { // use case 7
