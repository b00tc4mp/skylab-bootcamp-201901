...
class Detail extends Component {
    ...
    isFavorite = () => {
        ...
        return logic.retrieveUser().then(user => {
            ...
            console.log('desde isFavorite', typeof result)
    ...
    printDetails = () => {
        if (this.state.videoSelected) {
            const {handleFavorites, state: {classHeart, videoSelected: {Title, Runtime, Plot, Genre, Actors, Poster, Released, imdbID}}} = this
                                        ...
                                        { logic.userLoggedIn?
                                            <div>
                                                <hr />
                                                    ...
                                                    {classHeart? <i className="fas fa-heart"></i> : <i className="far fa-heart"></i>}
