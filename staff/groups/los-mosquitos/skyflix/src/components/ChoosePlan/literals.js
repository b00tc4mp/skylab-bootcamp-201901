export default {
    en: {
        planTitle: "Choose a plan that's right for you. Downgrade or upgrade at any time",
        plan1: 'Basic',
        plan2: 'Standard',
        plan3: 'Premium',
        option1: 'Monthly price',
        option2: 'HD available',
        option3: 'Ultra HD available',
    ...
    es: {
        ...
        plan2: 'Estándar',
        plan3: 'Premium',
        option1: 'Precio al mes',
        option2: 'Disponible en HD',
        option3: 'Disponible en ultra HD',
