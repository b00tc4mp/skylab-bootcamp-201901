 ...
 * @param {function} body - Suite body expression to evaluate.
 */
 ...
 * @param {*} body - Test set body expression to evaluate.
 */
function describe(description, body) {
    console.log('%c ' + description, 'color: blue; font-size: 1.5em;');
