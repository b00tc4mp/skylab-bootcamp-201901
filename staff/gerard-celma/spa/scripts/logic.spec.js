...
describe('logic', function () {
    ...
    describe('register', function () {
        ...
        it('should fail if email already exists', function () {
            var registered;
            ...
            }).toThrow(Error('user manuelbarzi@gmail.com already exists'));
        ...
        it('should fail on undefined password confirmation', function () {
            ...
            var registeringEmail = 'jw@mail.com';
            var registeringPassword = 'p4ssw0rd';
            var registeringPasswordConfirmation = undefined;
            ...
            }).toThrow(TypeError(registeringPasswordConfirmation + ' is not a string'));
        ...
        it('should fail on numeric password confirmation', function () {
            ...
            var registeringEmail = 'jw@mail.com';
            var registeringPassword = 'p4ssw0rd';
            var registeringPasswordConfirmation = 10;
        ...
        it('should fail on boolean password confirmation', function () {
            ...
            var registeringEmail = 'jw@mail.com';
            var registeringPassword = 'p4ssw0rd';
            var registeringPasswordConfirmation = true;
        ...
        it('should fail on password different than password confirmation', function () {
            var registered;
            ...
            var registeringEmail = 'jw@mail.com';
            var registeringPassword = 'p4ssw0rd';
            var registeringPasswordConfirmation = 'p4ss867rd';
        ...
        it('should fail on boolean callback', function () {
            ...
            expect(function () {
                register(registeringName, registeringSurname, registeringEmail, registeringPassword, registeringPassword, false);
            }).toThrow(TypeError('callback is not a function'));
        ...
        it('should fail on empty callback', function () {
            ...
            expect(function () {
                register(registeringName, registeringSurname, registeringEmail, registeringPassword, registeringPassword, '');
            }).toThrow(Error('callback is not a function'));
