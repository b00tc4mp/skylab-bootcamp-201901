    ...
    describe('users', () => {
        ...
        describe('toggleFavDuck', () => {
           let duckId = ('456')
            ...
            debugger 
            it('should succeed on correct status', () =>
                logic.toggleFavDuck(duckId)
                    ...
                    .then(response => {
                        ...
                        expect(data.favorites).toEqual({favorites:duckId})
                    })
            )
            ...
            it('should fail on undefined id', () => {
                ...
                expect(() => logic.toggleFavDuck(duckId)).toThrowError(RequirementError, `duckId is not optional`)
            })
