...
function Toolbar({ newFolder, newFile, openFinder, openMenu }) {
    ...
    return <section className="toolbar">
        <div className="toolbar__logo" onClick={(e) => openMenu(e)}><image className="toolbar__logo__image" alt="Metallic logo" width="42" height="42" src="../../media/logo.jpg"></image></div>
        <image className="toolbar__logo__image" alt="Metallic logo" width="42" height="42" src="../../media/logo.jpg"></image>
