  ...
  render() {
    ...
    return <div>
      <Switch>
        ...
        <Route exact path="/mapform/:id" render={() => logic.isUserLoggedIn ? <MapForm lang={lang} onLogout={handleLogout} /> : <Redirect to="/" />} />

        <Route path="/mapform" render={() => logic.isUserLoggedIn ? <MapForm lang={lang} onLogout={handleLogout} /> : <Redirect to="/" />} />
