...
const InfoWindow = props => {
  ...
  return (
    <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle" style={infoWindowStyle}>
      {place.urlImage && <div className="uk-card-media-top containnerCardImg">
      ...
      <div>
        <button className="uk-button uk-button-default uk-button-small" type="button" onClick={e => { e.stopPropagation(); props.onShow(place.id); }}>
          <img className="" src={iconShow} height="18" width="18" alt="" />
        </button>
        <button className="uk-button uk-button-default uk-button-small" type="button" onClick={e => { e.stopPropagation(); props.onEdit(place); }}>
          <img className="" src={iconEdit} height="15" width="15" alt="" />
        </button>
        <button className="uk-button uk-button-default uk-button-small" type="button" onClick={e => { e.stopPropagation(); props.onDelete(place.id); }}>
          <img className="" src={iconDelete} height="15" width="15" alt="" />
        </button>
        <button className="uk-button uk-button-default uk-button-small" type="button" onClick={e => { e.stopPropagation(); props.onCancel(place.id); }}>
