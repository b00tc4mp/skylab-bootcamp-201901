...
const NewPinWindow = props => {
  ...
  return (
    <div className="uk-flex  uk-flex-column uk-flex-center uk-flex-middle" onClick={stopPropagation} style={NewPinWindowStyle}>
      ...
      <div className="uk-container uk-margin-remove-top uk-padding-remove-left uk-padding-remove-right uk-align-center uk-text-meta mini-margin-bottom">
        ...
        <p className="uk-margin-remove-bottom uk-margin-remove-top">{latitude}{place.geometry.location.lat}</p>
        <p className="uk-margin-remove-bottom uk-margin-remove-top">{longitude}{place.geometry.location.lat}</p>
      </div>
      <div>
