    ...
    describe('users', () => {
        describe('register user', () => {
            ...
            it('should succeed on correct user data', async () => {
                ...
                const _users = await userData.find(user => user.matches({ name, surname, email, password }))
        ...
        describe('retrieve fav ducks', () => {
            ...
            it('should succeed on favs ducks', () =>
        ...
        describe('retrieve cart ducks', () => {
            ...
            it('should succeed on cart ducks', () =>
                logic.retrieveCartDucks(id)
                    .then(ducks => {
                        ducks.forEach(({ id, title, imageUrl, description, price }) => {
                            const isCart = _cart.some(cartId => cartId === id)
