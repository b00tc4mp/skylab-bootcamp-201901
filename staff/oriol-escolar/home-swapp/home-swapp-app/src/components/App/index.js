...
render() {
  ...
  const {
    ...
    handleGoToUser, handleGoToLanding, toggleFavs, updateInfo, onCreateHousePage, onCreateHouse,
    ...
    <div className="App" >
      ...
      <div className="content" >
        ...
        <Route exact path="/user" render={() => <div>
          <MyHouses user={user} userHouses={userHouses} updateInfo={updateInfo} onCreateHousePage={onCreateHousePage} />
