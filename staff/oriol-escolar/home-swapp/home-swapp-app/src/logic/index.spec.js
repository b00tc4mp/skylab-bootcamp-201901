...
describe('logic', () => {
    ...
    describe('retrieve spanish location', () => {
        ...
        it('should succeed on valid usa data', async () => {
            ...
            const location = await logic.retrievePoint(number,street,city,country)
        ...
        it('should fail on undefined number', () => {
            ...
            let number = '29'
            try {
                logic.retrievePoint(undefined,street,city,country)
        ...
        it('should fail on undefined street', () => {
            ...
            let number = '29'
            try {
                logic.retrievePoint(number,undefined,city,country)
        ...
        it('should fail on undefined city', () => {
            ...
            let number = '29'
            try {
                logic.retrievePoint(number,street,undefined,country)
        ...
        it('should fail on undefined country', () => {
            ...
            let number = '29'
            try {
                logic.retrievePoint(number,street,city,undefined)
        ...
        it('should fail on undefined country', () => {
           ...
           let country = 'sjbdjkasbdj'
            try {
                logic.retrievePoint(number,street,city,country)
