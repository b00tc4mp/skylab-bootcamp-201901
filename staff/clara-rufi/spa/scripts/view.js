...
registerForm.addEventListener('submit', function (event) {
    ...
    var errorPanel = document.getElementsByClassName('register__error')[0]; //no podem posar this.getElementByClassName com a dalt, pq esta a una seccio dif de l'html, el this no li pot fer referència.
