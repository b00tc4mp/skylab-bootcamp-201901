...
nameUser = []
    ...
    document.getElementById("timeFinished").style="display:none;"
...
document.getElementById("welcome").value = ""
    if (name.length >=2){
        ...
        document.getElementById("welcome").value += "Nombre válido mínimo 2 carácteres"
...
function start(){
    ...
    document.getElementById("minuts").style="display:block;"
    timer();
...
function end(){
    document.getElementById("showQuestion").value = nameUser + ", has acertado un total de " + numAcertadas + " letras y has fallado un total de " + numFalladas + " letras. Gracias por jugar!!"
    document.getElementById("showQuestion").style.backgroundColor = "Teal";
    document.getElementById("userAnswer").disabled = true; 
    document.getElementById('acceptar').disabled = true;
}
...
function Okrepeat (){
    ...
    } else if (n <= 26 && numAcertadasFalladas === 27){
        document.getElementById("showQuestion").value = nameUser + ", has acertado un total de " + numAcertadas + " letras y has fallado un total de " + numFalladas + " letras, pero ganas 1.000€ por participar. Felicidades!!"
        document.getElementById('repeatPasapalabra').style="display:none;"
        document.getElementById("end").style="display:none;" 
        document.getElementById('Okrepeat').style="display:none;"
...
function playAgainNo(){
    ...
    document.getElementById("bye").innerHTML = "Gracias por haber participado al pasapalabra, " + nameUser + "    :)"           
