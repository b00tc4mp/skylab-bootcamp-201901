...
document.getElementById('linia').style="display:none;"
document.getElementById('liniaOk').style="display:none;"
...
function evaluation(){
    ...
    if(posicio1 ===5 && posicio2 ===5 && posicio3 ===5){
        ...
        document.getElementById("bingo").value =  "BINGO! Felicidades " + nameUser + " !!"

    }else if (posicio1 === 5 && linia1 ===0){
        linia1 += 1
        document.getElementById('linia').style="display:block;"
        document.getElementById('liniaOk').style="display:block;"
        document.getElementById("linia").value =  "Linia!"
       

    }else if (posicio2 ===5 && linia2 ===0){
...
function bingoOk(){
    document.getElementById('bingoOk').style="display:none;"
