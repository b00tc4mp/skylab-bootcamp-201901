...
// // use case 3
test("optional arguments", function() {
  var arr = [1, 2, 3, 4, 5];
...
test("negative number as start and end arguments", function() {
  var arr = [1, 2, 3, 4, 5];
...
test("negative number as start argument", function() {
  var arr = [1, 2, 3, 4, 5];
...
// // use case 7
 ...
 test("fail on number instead of array",function useCase7() {
     var error;
