const padelcatApi = {
    ...
    registerPlayer(name, surname, email, password, passwordConfirm, preferedPosition, link) {
        ...
        return fetch(`${this.url}/register`, {
            ...
            body: JSON.stringify({ name, surname, email, password, passwordConfirm, preferedPosition, link })
        })
        .then(res => res.json())
        .then(({id, error}) => {
