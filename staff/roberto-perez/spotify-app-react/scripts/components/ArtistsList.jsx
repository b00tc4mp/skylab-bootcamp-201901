    ...
    return (
      <div className="container">
        <header className="search-section__header">
          <h3 className="search-section__title">Artists</h3>
        </header>
          ...
          {artists.map(({ id, name, images }) => {
            ...
            return (
              <div key={id} className="col-xs-6 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                <div className="artist" onClick={() => handleSearchAlbum(id)}>
                  <div className="artist__img-container">
                    <div className="artist__icon">
                      <svg
                        width="80"
                        height="79"
                        viewBox="0 0 80 79"
                    ...
                    {images[0] ? <div className="artist__image" style={{backgroundImage: 'url(' + images[0].url+ ')'}}></div> : ''}
                  </div>
